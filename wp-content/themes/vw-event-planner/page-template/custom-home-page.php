...
<main id="maincontent" role="main">
  ...
  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'vw_event_planner_slider_speed',3000)) ?>"> 
