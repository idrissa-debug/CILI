<?php
	...
	if($vw_event_planner_second_color != false || $vw_event_planner_first_color != false){
		$vw_event_planner_custom_css .='.home-page-header, input[type="submit"], .scrollup i, .footer-2, .view-more, #comments input[type="submit"], #slider, .footer .woocommerce-product-search button, .sidebar .woocommerce-product-search button, .footer a.custom_read_more, .sidebar a.custom_read_more, .wp-block-button__link, .wp-block-button .wp-block-button__link:hover{
	...
	if($vw_event_planner_slider_height != false){
		$vw_event_planner_custom_css .='#slider img{';
			$vw_event_planner_custom_css .='height: '.esc_html($vw_event_planner_slider_height).';';
		$vw_event_planner_custom_css .='}';
	}
    ...
    if($vw_event_planner_resp_scroll_top == true){
		...
		$vw_event_planner_custom_css .='@media screen and (max-width:575px) {';
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='display:none !important;';
		$vw_event_planner_custom_css .='} }';
	}
	...
	if($vw_event_planner_sticky_header_padding != false){
		$vw_event_planner_custom_css .='.header-fixed{';
			$vw_event_planner_custom_css .='padding: '.esc_html($vw_event_planner_sticky_header_padding).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_scroll_to_top_font_size != false){
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='font-size: '.esc_html($vw_event_planner_scroll_to_top_font_size).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_scroll_to_top_padding != false){
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='padding-top: '.esc_html($vw_event_planner_scroll_to_top_padding).';padding-bottom: '.esc_html($vw_event_planner_scroll_to_top_padding).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_scroll_to_top_width != false){
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='width: '.esc_html($vw_event_planner_scroll_to_top_width).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_scroll_to_top_height != false){
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='height: '.esc_html($vw_event_planner_scroll_to_top_height).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_scroll_to_top_border_radius != false){
		$vw_event_planner_custom_css .='.scrollup i{';
			$vw_event_planner_custom_css .='border-radius: '.esc_html($vw_event_planner_scroll_to_top_border_radius).'px;';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_social_icon_font_size != false){
		$vw_event_planner_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_event_planner_custom_css .='font-size: '.esc_html($vw_event_planner_social_icon_font_size).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_social_icon_padding != false){
		$vw_event_planner_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_event_planner_custom_css .='padding: '.esc_html($vw_event_planner_social_icon_padding).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_social_icon_width != false){
		$vw_event_planner_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_event_planner_custom_css .='width: '.esc_html($vw_event_planner_social_icon_width).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_social_icon_height != false){
		$vw_event_planner_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_event_planner_custom_css .='height: '.esc_html($vw_event_planner_social_icon_height).';';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_social_icon_border_radius != false){
		$vw_event_planner_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_event_planner_custom_css .='border-radius: '.esc_html($vw_event_planner_social_icon_border_radius).'px;';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_products_padding_top_bottom != false){
		$vw_event_planner_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_event_planner_custom_css .='padding-top: '.esc_html($vw_event_planner_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($vw_event_planner_products_padding_top_bottom).'!important;';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_products_padding_left_right != false){
		$vw_event_planner_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_event_planner_custom_css .='padding-left: '.esc_html($vw_event_planner_products_padding_left_right).'!important; padding-right: '.esc_html($vw_event_planner_products_padding_left_right).'!important;';
		$vw_event_planner_custom_css .='}';
	}
	...
	if($vw_event_planner_products_box_shadow != false){
		$vw_event_planner_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_event_planner_custom_css .='box-shadow: '.esc_html($vw_event_planner_products_box_shadow).'px '.esc_html($vw_event_planner_products_box_shadow).'px '.esc_html($vw_event_planner_products_box_shadow).'px #ddd;';
		$vw_event_planner_custom_css .='}';
	}

	$vw_event_planner_products_border_radius = get_theme_mod('vw_event_planner_products_border_radius');
	if($vw_event_planner_products_border_radius != false){
		$vw_event_planner_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_event_planner_custom_css .='border-radius: '.esc_html($vw_event_planner_products_border_radius).'px;';
		$vw_event_planner_custom_css .='}';
	}